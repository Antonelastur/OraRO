...
Fișele lecțiilor 1, 5, 6, 7, 9, 11, 13, 20 și 21 și infograficul lecției 8 sunt gata, integrate în cod.
...
Fișele lecțiilor 2, 5, 6, 8, 11, 13, 21 și 22 și infograficele lecțiilor 7, 9 și 10 sunt gata, integrate în cod. Decizii: lecția 5 (schemă sau fișă) a fost făcută **fișă** cu exerciții de scanare a versurilor, măsură, rimă, ritm — mai utilă decât o schemă statică; lecția 13 (fișă sau infografic) a fost făcută **fișă** cu un termometru al atitudinilor sub formă de tabel de autoevaluare 1-5, la fel ca activitatea din manual (p. 100).

## Unitatea IV: Popasuri cu tâlc

| Lecție | Titlu | Lipsește |
|---|---|---|
| lectia-1 | Textul narativ literar în versuri. Uliul și găinile | prezentare |
...
Fișele lecțiilor 1, 5, 6, 7, 9, 11, 13, 15, 17 și 19 și infograficul lecției 10 sunt gata, integrate în cod.

## Total cumulativ, toate cele 5 unități + recapitulare inițială

**122 de lecții** construite structural (id, titlu, obiective, sursaManual, toate verificate direct în manual sau, pentru recapitulare, în clasa a V-a). **110 lecții au material**. **12 lecții au `materiale` null**, din care 11 sunt restante reale, listate mai sus, și 1 (Unitatea I, lecția 12) e intenționat fără material, manualul are deja activitatea completă.

Cele 11 lecții restante, pe tip de resursă:

- prezentare: 6 (U1 L1/L5, U2 L2, U3 L1, U4 L1, U5 L2), NotebookLM sau Canva
- test (Google Forms, itemii pot fi propuși de Claude, forma finală o construiește Antoanela): 5, câte unul pe unitate

Toate materialele automate ale clasei a VI-a sunt gata: 42 de fișe (`scripts/build_clasa6_fise.py`) și 6 infografice SVG (`scripts/build_clasa6_infografice.py`). Rămân doar prezentările și testele, care cer unelte externe.
