  ...
  lectii: [
      ...
      planLectie: {
        ...
        desfasurare: [
          ...
          },
          {
            ...
            timp: '7 min',
            activitate: 'Îi întreb pe elevi ce s-ar schimba în lumea lor dacă, de mâine, cărțile ar fi interzise.',
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că deschidem ultima unitate cu un fragment din Fahrenheit 451 de Ray Bradbury și formulăm primele impresii.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '6 min',
            activitate: 'Reluăm reperele textului epic, narator, personaje, conflict, lucrate în Unitatea IV.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '22 min',
            activitate: 'Citim fragmentul, clarific termenii și contextul, apoi urmărim lumea în care pompierii ard cărți în loc să stingă focul, cu exemplele de la pp. 164-169.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '10 min',
            activitate: 'Fiecare elev notează două impresii de lectură și detaliul care i s-a părut cel mai tulburător.',
          },
        ],
      ...
      planLectie: {
        ...
        desfasurare: [
          ...
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că azi definim distopia și vedem de ce un roman se împarte în părți și capitole.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '6 min',
            activitate: 'Reluăm impresiile de ora trecută și noțiunea de text epic, comparând nuvela cu romanul ca întindere.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '24 min',
            activitate: 'Definim distopia, cu trăsăturile ei, societate opresivă, control al informației, personaj care se trezește, apoi discutăm rolul decupajului în părți și capitole, cu exemplele de la pp. 170-171.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '9 min',
            activitate: 'Fiecare elev notează trei trăsături ale distopiei regăsite în fragment, cu dovada din text.',
          },
        ],
    ...
    },
    {
      ...
      planLectie: {
        ...
        resurse: [
          ...
          'Fișa lecției (/materiale/clasa-8/unitatea-5/lectia-3/fisa.pdf)',
          'Caietele elevilor',
        ],
        desfasurare: [
          {
          ...
          },
          {
            etapa: 'Captarea atenției',
            timp: '5 min',
            activitate: 'Le arăt trei pasaje din fragment și îi întreb pe elevi ce face fiecare: povestește, descrie sau dă replici.',
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că azi vedem cum se îmbină structurile textuale: prin succesiune, alternanță și inserție.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '6 min',
            activitate: 'Reluăm cele cinci structuri textuale din Unitatea III și inserția, învățată în Unitatea IV.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '24 min',
            activitate: 'Cu ajutorul fișei lecției marcăm structurile din fragment și definim cele trei moduri de îmbinare, succesiune, alternanță, inserție, cu exemplele de la pp. 172-173.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '10 min',
            activitate: 'Fiecare elev identifică într-un pasaj dat modul de îmbinare a structurilor și îl justifică.',
          },
        ],
    ...
    },
    {
      ...
      planLectie: {
        ...
        resurse: [
          ...
          'Fișa lecției (/materiale/clasa-8/unitatea-5/lectia-4/fisa.pdf)',
          'Caietele elevilor',
        ],
        desfasurare: [
          {
          ...
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că azi clasificăm personajele și identificăm tipurile de conflict din roman.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '6 min',
            activitate: 'Reluăm caracterizarea personajului și antiteza, din Unitatea IV.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '24 min',
            activitate: 'Cu ajutorul fișei lecției clasificăm personajele, principal, secundar, episodic, rotund, plat, și inventariem sursele de conflict, om cu om, om cu societate, om cu sine, cu exemplele de la pp. 174-175.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '10 min',
            activitate: 'Fiecare elev completează o fișă cu două tipuri de conflict din roman și replica sau scena care le dovedește.',
          },
        ],
    ...
    },
    {
      ...
      planLectie: {
        ...
        resurse: [
          ...
          'Fișa lecției (/materiale/clasa-8/unitatea-5/lectia-5/fisa.pdf)',
          'Caietele elevilor',
        ],
        desfasurare: [
          {
          ...
          },
          {
            etapa: 'Captarea atenției',
            timp: '5 min',
            activitate: 'Le spun titlurile celor trei părți ale romanului și îi întreb ce anticipează fiecare.',
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că azi interpretăm simbolurile romanului, focul, cartea, pasărea Phoenix, și titlurile părților.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '6 min',
            activitate: 'Reluăm conflictele identificate ora trecută și trăsăturile distopiei.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '25 min',
            activitate: 'Cu ajutorul fișei lecției discutăm dubla valoare a focului, distrugere și renaștere, și semnificația titlurilor celor trei părți, cu exemplele de la pp. 176-177.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '9 min',
            activitate: 'Fiecare elev alege un simbol și explică în scris ce semnifică, sprijinindu-se pe un pasaj din text.',
          },
        ],
    ...
    },
    {
      ...
      planLectie: {
        ...
        resurse: [
          ...
          'Fișa lecției (/materiale/clasa-8/unitatea-5/lectia-6/fisa.pdf)',
          'Caietele elevilor',
        ],
        desfasurare: [
          {
          ...
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că citim un text de opinie despre viitorul muncii și îi analizăm strategiile de argumentare.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '6 min',
            activitate: 'Reluăm textul argumentativ din Unitatea III și tiparul pro-contra din Unitatea IV.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '23 min',
            activitate: 'Cu ajutorul fișei lecției identificăm teza autorului, argumentele și strategiile folosite, obiecția, concesia, analogia, examenul critic, confruntarea, cu exemplele de la pp. 178-180.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '10 min',
            activitate: 'Fiecare elev extrage teza textului și două argumente și precizează strategia folosită la unul dintre ele.',
          },
        ],
    ...
    },
    {
      ...
      planLectie: {
        ...
        resurse: [
          ...
          'Fișa lecției (/materiale/clasa-8/unitatea-5/lectia-7/fisa.pdf)',
          'Caietele elevilor',
        ],
        desfasurare: [
          {
          ...
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că citim Prima lecție de geometrie și ne formulăm puncte de vedere argumentate despre ea.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '6 min',
            activitate: 'Reluăm tema unității, încotro se îndreaptă lumea, și rolul cunoașterii, discutat la textele anterioare.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '23 min',
            activitate: 'Citim fragmentul, discutăm relația dintre profesor și elevi și ce înseamnă o lecție care schimbă felul de a gândi, cu ajutorul fișei lecției și al exemplelor de la pp. 181-182.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '10 min',
            activitate: 'Fiecare elev formulează un punct de vedere argumentat despre ce face ca o lecție să fie memorabilă.',
          },
        ],
      ...
      planLectie: {
        ...
        desfasurare: [
          ...
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că citim din Prometeu înlănțuit de Eschil și discutăm modelul eroului care sfidează puterea.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '5 min',
            activitate: 'Reluăm figura lui Montag din Fahrenheit 451, care se ridică și el împotriva unei ordini nedrepte.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '23 min',
            activitate: 'Cu ajutorul infograficului și al fragmentului discutăm mitul lui Prometeu, focul furat ca simbol al cunoașterii și ecoul lui în literatura universală, cu exemplele de la pp. 184-185.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '11 min',
            activitate: 'Fiecare elev notează două asemănări între Prometeu și un personaj din unitate și explică ce model de comportament propun amândoi.',
          },
        ],
    ...
    },
    {
      ...
      planLectie: {
        ...
        resurse: [
          ...
          'Quizul „Argumentare și persuasiune” (materialul de joc al lecției)',
          'Caietele elevilor',
        ],
        desfasurare: [
          {
          ...
          },
          {
            etapa: 'Captarea atenției',
            timp: '5 min',
            activitate: 'Le dau un argument evident greșit, „toți fac așa, deci e corect", și îi întreb pe elevi ce nu funcționează în el.',
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că azi învățăm cele trei elemente ale persuasiunii și recunoaștem erorile logice.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '6 min',
            activitate: 'Reluăm structura argumentării din Unitatea III și comportamentele persuasive din Unitatea IV.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '22 min',
            activitate: 'Cu exemplele de la pp. 186-187 definim logos, patos și etos, discutăm justețea premiselor și relația argument, concluzie, și analizăm erori logice frecvente.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '12 min',
            activitate: 'Elevii rezolvă quizul „Argumentare și persuasiune", apoi identifică eroarea logică din trei argumente date.',
          },
        ],
    ...
    },
    {
      ...
      planLectie: {
        ...
        resurse: [
          'Manual Art 8, pp. 186-187',
          'Quizul „Argumentare și persuasiune, aplicații” (materialul de joc al lecției)',
        ...
        desfasurare: [
          ...
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că azi construim și susținem oral o argumentare pe tema Școala viitorului.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '6 min',
            activitate: 'Reluăm logos, patos și etos și tipurile de argumente, raționale, emoționale, morale.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '20 min',
            activitate: 'Prezint grila de evaluare, argumente logice, exemple relevante, stil atractiv, apoi elevii își construiesc argumentarea în perechi, alegând conștient strategiile.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '15 min',
            activitate: 'Câțiva elevi susțin argumentarea în fața clasei, colegii evaluează pe grilă, apoi toți rezolvă quizul de aplicații.',
          },
        ],
      ...
      planLectie: {
        ...
        desfasurare: [
          ...
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că azi învățăm circumstanțialul de cauză și diferența de sens dintre „din cauza" și „datorită".',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '7 min',
            activitate: 'Reluăm circumstanțialele de loc, timp și mod, studiate în Unitatea IV.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '22 min',
            activitate: 'Cu ajutorul schemei lecției stabilim întrebările, părțile de vorbire prin care se exprimă și insistăm pe „datorită" pentru cauze pozitive și „din cauza" pentru cele negative, cu exemplele de la p. 188.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '11 min',
            activitate: 'Fiecare elev identifică circumstanțialele de cauză dintr-un fragment și corectează trei enunțuri cu prepoziția greșită.',
          },
        ],
      ...
      planLectie: {
        ...
        desfasurare: [
          ...
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că azi trecem de la circumstanțialul de cauză la propoziția circumstanțială de cauză.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '7 min',
            activitate: 'Reluăm circumstanțialul de cauză din lecția precedentă și modelul celorlalte circumstanțiale propoziționale.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '22 min',
            activitate: 'Cu ajutorul schemei lecției inventariem elementele de relație, fiindcă, deoarece, întrucât, pentru că, discutăm termenii regenți, topica și virgula, cu exemplele de la pp. 189-190.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '11 min',
            activitate: 'Fiecare elev transformă trei circumstanțiale de cauză în propoziții și analizează frazele obținute.',
          },
        ],
      ...
      planLectie: {
        ...
        desfasurare: [
          ...
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că azi învățăm circumstanțialul de scop și îl deosebim de cel de cauză.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '7 min',
            activitate: 'Reluăm circumstanțialul și circumstanțiala de cauză, cele mai ușor de confundat cu scopul.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '22 min',
            activitate: 'Cu ajutorul schemei lecției stabilim întrebările, părțile de vorbire prin care se exprimă și proba de deosebire față de cauză, cauza precedă acțiunea, scopul o urmează, cu exemplele de la p. 191.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '11 min',
            activitate: 'Fiecare elev analizează șase enunțuri și precizează, pentru fiecare, dacă e vorba de cauză sau de scop.',
          },
        ],
      ...
      planLectie: {
        ...
        desfasurare: [
          ...
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că azi învățăm circumstanțiala de scop și metoda de a o deosebi de completive.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '7 min',
            activitate: 'Reluăm completivele din Unitatea III și circumstanțialul de scop din lecția precedentă.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '22 min',
            activitate: 'Cu ajutorul schemei lecției inventariem elementele de relație, să, ca să, pentru ca să, și arătăm că întrebarea se pune de la regent, cu exemplele de la pp. 192-193.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '11 min',
            activitate: 'Fiecare elev analizează patru fraze introduse prin „să" și precizează felul subordonatei, justificând prin întrebare.',
          },
        ],
      ...
      planLectie: {
        ...
        desfasurare: [
          ...
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că azi învățăm construcțiile concesive, cele care arată un obstacol depășit.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '7 min',
            activitate: 'Reluăm circumstanțialele de cauză și de scop, ca să le așezăm pe toate în seria raporturilor logice.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '22 min',
            activitate: 'Cu ajutorul schemei lecției identificăm concesia la nivel de propoziție și de frază și inventariem elementele de relație, deși, cu toate că, chiar dacă, măcar că, cu exemplele de la pp. 194-195.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '11 min',
            activitate: 'Fiecare elev construiește patru enunțuri concesive, două la nivel de propoziție și două de frază.',
          },
        ],
      ...
      planLectie: {
        ...
        desfasurare: [
          ...
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că azi învățăm construcțiile condiționale și le deosebim de cele concesive.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '7 min',
            activitate: 'Reluăm construcțiile concesive din lecția precedentă și modul condițional-optativ.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '22 min',
            activitate: 'Cu ajutorul schemei lecției identificăm condiționalul la nivel de propoziție și de frază, inventariem elementele de relație, dacă, de, să, în caz că, și discutăm corespondența modurilor și timpurilor, cu exemplele de la pp. 196-197.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '11 min',
            activitate: 'Fiecare elev construiește trei fraze condiționale pe tema unității și le deosebește de două fraze concesive date.',
          },
        ],
    ...
    },
    {
      ...
      planLectie: {
        ...
        resurse: [
          ...
          'Fișa lecției (/materiale/clasa-8/unitatea-5/lectia-17/fisa.pdf)',
          'Caietele elevilor',
        ],
        desfasurare: [
          {
          ...
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că azi învățăm cum se exprimă în limbă preferința, certitudinea, probabilitatea și necesitatea.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '6 min',
            activitate: 'Reluăm textul de opinie și strategiile de argumentare studiate mai devreme în unitate.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '24 min',
            activitate: 'Cu ajutorul fișei lecției inventariem mijloacele de exprimare a atitudinii subiective, verbe, adverbe, construcții, și le grupăm pe certitudine, probabilitate, necesitate, preferință, cu exemplele de la pp. 198-199.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '10 min',
            activitate: 'Fiecare elev rescrie trei enunțuri, schimbând gradul de certitudine, și explică ce se schimbă în mesaj.',
          },
        ],
    ...
    },
    {
      ...
      planLectie: {
        ...
        resurse: [
          'Manual Art 8, pp. 198-199',
          'Fișa lecției (/materiale/clasa-8/unitatea-5/lectia-18/fisa.pdf)',
        ...
        desfasurare: [
          ...
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că azi redactăm textul de opinie cu titlul unității și îl revizuim.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '5 min',
            activitate: 'Reluăm etapele scrierii, structura textului de opinie și mijloacele de exprimare a certitudinii și a probabilității.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '19 min',
            activitate: 'Cu ajutorul fișei lecției construim planul textului, teza, argumentele cu exemple, nuanțarea prin modalizatori, concluzia, cu reperele de la pp. 198-199.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '17 min',
      ...
      planLectie: {
        ...
        desfasurare: [
          ...
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că recapitulăm distopia, structurile textuale, personajele, conflictul și textul de opinie.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '8 min',
            activitate: 'Reluăm trăsăturile distopiei, cele trei moduri de îmbinare a structurilor, tipurile de personaje și sursele conflictului.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '18 min',
            activitate: 'Rezolvăm ghidat exercițiile de lectură de la pp. 200-201.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '15 min',
      ...
      planLectie: {
        ...
        desfasurare: [
          ...
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că recapitulăm circumstanțialele de cauză și de scop și construcțiile concesive și condiționale.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '8 min',
            activitate: 'Reluăm, cu exemple la tablă, întrebările și elementele de relație pentru fiecare tip studiat, plus regula „datorită" față de „din cauza".',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '16 min',
            activitate: 'Rezolvăm ghidat exercițiile de limbă română de la pp. 200-201.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '17 min',
            activitate: 'Elevii rezolvă quizul, apoi cei care termină analizează o frază complexă cu mai multe subordonate.',
          },
        ],
        evaluare: 'Observarea sistematică a elevilor; rezultatele la quiz.',
      },
      ...
      planLectie: {
        ...
        desfasurare: [
          ...
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că recapitulăm argumentarea persuasivă, modalizatorii și textul de opinie.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '8 min',
            activitate: 'Reluăm logos, patos și etos, strategiile textului de opinie și mijloacele de exprimare a atitudinii subiective.',
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '16 min',
            activitate: 'Rezolvăm ghidat exercițiile de comunicare orală și redactare de la pp. 200-201.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '17 min',
            activitate: 'Elevii rezolvă quizul, apoi câțiva își susțin oral textul de opinie, iar colegii evaluează forța argumentelor.',
          },
        ],
      ...
      planLectie: {
        ...
        desfasurare: [
          ...
          },
          {
            etapa: 'Enunțarea subiectului și a obiectivelor',
            timp: '2 min',
            activitate: 'Anunț că se dă proba scrisă a Unității V, care verifică lectura, limba română și redactarea.',
          },
          {
            etapa: 'Reactualizarea cunoștințelor anterioare',
            timp: '3 min',
          ...
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '5 min',
            activitate: 'Distribui testele de la p. 202, citesc cerințele cu voce tare, explic punctajul și răspund la întrebările de clarificare.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '35 min',
      ...
      planLectie: {
        ...
        desfasurare: [
          ...
          },
          {
            etapa: 'Dirijarea învățării',
            timp: '20 min',
            activitate: 'Discut pe rând greșelile tipice din probă, arăt cum se corectează, apoi înmânez lucrările și trec pe la fiecare elev cu o observație scurtă și concretă.',
          },
          {
            etapa: 'Obținerea performanței',
            timp: '13 min',
            activitate: 'Fiecare elev își prezintă portofoliul, alege piesa de care e cel mai mândru și explică de ce; completez grila de evaluare a portofoliului.',
          },
        ],
